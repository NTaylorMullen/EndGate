...
(function (CollisionDetection) {
    var Game = (function (_super) {
        ...
        Game.prototype.Clear = // Remove all the shapes from the shape list (so they're not updated), Scene so they're not drawn, and CollisionManager so they don't collide
        function () {
            for(var i = 0; i < this._shapes.length; i++) {
        ...
        Game.prototype.AddShape = // Helper function to add shapes to all the necessary monitors
        function (shape) {
        ...
        Game.prototype.GetRandomPosition = // Helper functions to generate random values for all of the MovingShapeparameters
        function () {
