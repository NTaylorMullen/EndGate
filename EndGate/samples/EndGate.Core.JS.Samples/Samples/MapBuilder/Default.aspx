...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script typescript="true" src="TileSelector.js"></script>
    <script typescript="true" src="CameraDragController.js"></script>
    <script typescript="true" src="CameraZoomController.js"></script>
    <script typescript="true" src="SetupManager.js"></script>
    <script typescript="true" src="PersistenceManager.js"></script>
    <script typescript="true" src="OutputHandler.js"></script>
