    ...
    var Knight = (function (_super) {
        ...
        function Knight(startPosition) {
            ...
            this.MovementController = new eg.MovementControllers.LinearMovementController([
                this.Bounds, 
                this.Graphic
            ], Knight.MoveSpeed, /*rotateWithMovements*/ false, /*multiDirectional*/ false);
        ...
        Knight.prototype.Update = // Updates the movement controller to abide by controls and update the animation handler so that the knights graphic is updated correctly
        function (gameTime) {
