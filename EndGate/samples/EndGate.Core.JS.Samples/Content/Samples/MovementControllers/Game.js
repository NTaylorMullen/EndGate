...
(function (MovementControllers) {
    var Game = (function (_super) {
        ...
        Game.prototype.Update = // We need to update the movement controller so that it can move in the appropriate direction
        function (gameTime) {
            this._characterMovementController.Update(gameTime);
        };
        Game.prototype.BindKeys = // Helper function to bind keyboard controls to trigger the appropriate movement controller bindings
