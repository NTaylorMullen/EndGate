...
(function (MouseInput) {
    var Game = (function (_super) {
        ...
        Game.prototype.MarkLocationWithCircle = // Helper function to add shapes to our managed shapes list and to the scene simultaneously
        function (position, radius, color) {
            var shape = new eg.Graphics.Circle(position.X, position.Y, radius, color);
            this._shapes.push(shape);
            this.Scene.Add(shape);
        };
        Game.prototype.MarkLocationWithRectangle = // Helper function to add shapes to our managed shapes list and to the scene simultaneously
        function (position, size, color) {
