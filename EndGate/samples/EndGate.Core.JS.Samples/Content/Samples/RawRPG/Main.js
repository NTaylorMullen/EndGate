...
(function ($, window) {
    ...
    new eg.Graphics.Assets.ImageSource("/Content/Samples/RawRPG/images/wood_tileset_3.png", 512, 512), resources = // Build a resource array based on the sprite sheet, this is a linear array (not multi-dimensional)
