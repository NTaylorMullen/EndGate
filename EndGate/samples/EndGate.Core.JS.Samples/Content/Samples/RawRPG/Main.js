...
(function ($, window) {
    ...
    var canvas = document.createElement("canvas"), holder = $("#gameHolder"), game = null, resourceSheet = new eg.Graphics.ImageSource("/Content/Samples/RawRPG/images/wood_tileset_3.png", 512, 512), resources = eg.Graphics.SquareTileMap.ExtractTiles(resourceSheet, 32, 32), loadMapHandler;
