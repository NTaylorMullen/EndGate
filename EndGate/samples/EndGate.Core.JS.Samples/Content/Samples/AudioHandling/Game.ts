...
module AudioHandling {
    ...
    export class Game extends eg.Game {
        ...
        constructor(canvas: HTMLCanvasElement) {
            ...
            this._smokePoofManager = new SmokePoofManager(this.Input.Mouse, this.Scene, this.Audio.Load("poof", ["/Content/Samples/AudioHandling/sounds/smokepoof.ogg", "/Content/Samples/AudioHandling/sounds/smokepoof.mp3"]));
