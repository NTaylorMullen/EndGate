...
(function (AudioHandling) {
    var Game = (function (_super) {
        ...
        function Game(canvas) {
            ...
            this._smokePoofManager = new AudioHandling.SmokePoofManager(this.Input.Mouse, this.Scene, this.Audio.Load("poof", [
                "/Content/Samples/AudioHandling/sounds/smokepoof.ogg", 
                "/Content/Samples/AudioHandling/sounds/smokepoof.mp3"
            ]));
            ...
            this.Audio.Load("burning", [
                "/Content/Samples/AudioHandling/sounds/fireburning.ogg", 
                "/Content/Samples/AudioHandling/sounds/fireburning.mp3"
            ]);
