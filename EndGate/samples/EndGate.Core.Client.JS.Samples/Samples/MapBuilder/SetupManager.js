var SetupManager = (function () {
    function SetupManager(setupPane, builderPane, spriteSheetViewerCanvas, mapBuilderCanvas) {
        ...
        setupPane.find("#createMap").click(function () {
            ...
            _this._mapBuilder = new MapBuilder(mapBuilderCanvas, builderPane.find("#mapBuilderUtilities"), _this._spriteSheetViewer, parseInt(dimensionRows.val()), parseInt(dimensionColumns.val()), parseFloat(tileSizeWidth.val()), parseFloat(tileSizeHeight.val()));
